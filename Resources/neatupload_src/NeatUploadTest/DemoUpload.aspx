<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DemoUpload.aspx.cs" Inherits="NeatUploadTest.DemoUpload" %>
...
<body>
    ...
    <p>
        This page demonstrates the basic functionality of <a href="http://www.brettle.com/neatupload">
            NeatUpload</a>. Start by selecting the progress bar location and submit button
        type you'd like to see demostrated.
    </p>
    <p>
        ...
        <a href="javascript:NeatUploadConsole.open('Console opened')">Show NeatUpload Console
            (for debugging)</a>
    </p>
    <p>
    ...
    <p>
        ...
        <%--<Upload:MultiFile ID="multiFile" runat="server" UseFlashIfAvailable="true" FlashFilterExtensions="*.jpg;*.gif;*.png">
            <asp:Button ID="multiFileButton" Text="Add File..." Enabled="<%# multiFile.Enabled %>"
                runat="server" />
        </Upload:MultiFile>--%>
    ...
    <p>
        Other file(s) to upload (just to demonstrate multiple MultiFileControls on the same
        page):
        <%--<Upload:MultiFile ID="multiFile2" runat="server" UseFlashIfAvailable="true">
            <asp:Button ID="multiFileButton2" Text="Add File..." Enabled="<%# multiFile2.Enabled %>"
                runat="server" />
        </Upload:MultiFile>--%>
    </p>
    <p>
    ...
    <p>
        ...
        </span><span id="htmlInputButtonButtonSpan" runat="server">
            <input type="Button" id="htmlInputButtonButton" runat="server" name="htmlInputButtonButton"
                value="Submit" />
            <input type="Button" id="cancelhtmlInputButtonButton" runat="server" name="htmlInputButtonButton"
                value="Cancel" /><br />
        </span><span id="htmlInputButtonSubmitSpan" runat="server">
            <input type="Submit" id="htmlInputButtonSubmit" runat="server" name="htmlInputButtonSubmit"
                value="Submit" />
            <input type="Submit" id="cancelhtmlInputButtonSubmit" runat="server" name="htmlInputButtonSubmit"
                value="Cancel" /><br />
        </span>
    </p>
    <p>
        NeatUpload stores uploaded files in temporary storage on the server and automatically
        deletes them when your request completes. A real application would move or copy
        the files to their permanent location. This demo just displays the files' name,
    ...
    <div id="inlineProgressBarDiv" runat="server">
        ...
        <p>
            By default, an inline progress bar is always displayed. The inline progress bar
            above has been customized with javascript (see HTML source for this page) to hide
            the progress bar except when the upload is in progress or an error has occurred.
