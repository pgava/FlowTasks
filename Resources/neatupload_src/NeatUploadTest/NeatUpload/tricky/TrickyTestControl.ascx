<%@ Control language="c#" CodeBehind="TrickyTestControl.ascx.cs" AutoEventWireup="false" Inherits="Brettle.Web.NeatUpload.TrickyTestControl" %>
...
<table width="100%">
    ...
    <tr>
        <td colspan="2" align="center"><Upload:ProgressBar id="inlineProgressBar" runat="server" inline="true" Url="~/NeatUpload/tricky/Progress.aspx" /></td>
    </tr>
</table>
