...
namespace Brettle.Web.NeatUpload
{
	public class UploadStorage
	{
        ...
        public static UploadStorageProvider ProviderFromSectionName(string sectionName)
        {
            Config config = System.Configuration.ConfigurationManager.GetSection(sectionName) as Config;
            if (config.DefaultStorageProviderName == null)
            {
                return LastResortProvider;
            }
