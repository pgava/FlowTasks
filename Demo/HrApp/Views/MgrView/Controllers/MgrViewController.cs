...
namespace HrView.MgrView.Controllers
{
    public class MgrViewController : BaseController
    {
        public MgrViewController(IFlowUsersService usersService, IFlowTasksService tasksService, IFlowDocsDocument document) :
