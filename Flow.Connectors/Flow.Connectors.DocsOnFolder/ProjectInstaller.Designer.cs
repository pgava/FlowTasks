namespace Flow.Connectors.DocsOnFolder
{
   partial class ProjectInstaller
   {
      ...
      private void InitializeComponent()
      {
         ...
         // 
         this.callidenServiceInstaller.Description = "Docs on Folder connector.";
         this.callidenServiceInstaller.DisplayName = "Docs on Folder";
         this.callidenServiceInstaller.ServiceName = "Docs on Folder";
